...
public class FaceManger {
    ...
    private FaceManger(Builder builder) {
        this.mCameraId = String.valueOf(builder.cameraId);
        this.mTextureView = builder.textureView;
        this.activity = builder.activity;
        this.mFile = builder.file;
        this.onImageCapturedListener = builder.onImageCapturedListener;
    }
    ...
    public static class Builder {
        ...
        public Builder setmCameraId(int cameraId) {
        ...
        public Builder setmTextureView(TextureView textureView) {
        ...
        public OnImageCapturedListener getOnImageCapturedListener() {
            return onImageCapturedListener;
        }

        public Builder setOnImageCapturedListener(OnImageCapturedListener onImageCapturedListener) {
            this.onImageCapturedListener = onImageCapturedListener;
            return this;
        }


        public FaceManger build() {
            return new FaceManger(this);
        }
    }
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            try {
                ...
                //生成的翻转后的bitmap
                Bitmap captureBitmap = Bitmap.createBitmap(bitmap, 0, 0, w, h, m, true);
                ...
                if (onImageCapturedListener != null) {
                    onImageCapturedListener.onImageCaptured();
                }
