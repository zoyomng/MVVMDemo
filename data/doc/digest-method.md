...
public class RSAUtils {
    ...
    public static PublicKey getPublicKey(String publicKey) {
        try {
            ...
            LogUtil.e("获取公钥方法异常：" + e.getMessage());
        }
        return null;
    }
...
String sourceData = "{" +
        "\"phone\": \"" + phone + "\"," +
        "\"network_ip\": \"" + IPUtil.getIp(mContext) + "\"," +
        "\"type\": \"" + type + "\"" +
        "}";
PublicKey publicKey = RSAUtils.getPublicKey(Constants.PUBLIC_KEY);
byte[] encrypt = new byte[0];
encrypt = RSAUtils.encrypt(sourceData.getBytes(), publicKey);
