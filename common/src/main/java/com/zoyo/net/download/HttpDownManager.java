...
import com.zoyo.net.download.DownLoadListener.DownloadInterceptor;
import com.zoyo.net.download.DownLoadListener.ProgressDownSubscriber;
    ...
    public void startDown(final DownInfo info) {
        ...
        if (downInfos.contains(info)) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .baseUrl("http://192.168.97.36:8666/")
                    .build();
        ...
        /*得到rx对象-上一次下載的位置開始下載*/
        httpService.download(info.getUrl())
                /*指定线程*/
